  ...
  translation: {logoutConfirm: {
    ...
    settings: {
      ...
      backup: {
        ...
        progress: {
          importPreparingTitle: "正在整理导入数据",
          importPreparingDetail: "正在校验导入文件内容",
          importReadingLocalTitle: "正在读取当前本地数据",
          importReadingLocalDetail: "正在准备合并导入内容",
          importWritingLocalTitle: "正在写入本地数据",
          importWritingLocalDetail: "正在把导入数据应用到当前设备",
          importMergingTitle: "正在合并导入数据",
          importMergingDetail: "正在对齐快捷方式与书签的最新状态",
          importSyncingTitle: "正在同步导入结果",
          importSyncingDetail: "正在把最新数据写回账号云端",
          importLongTaskTitle: "正在导入数据",
          importLongTaskDetail: "正在写入本地数据，请稍候",

          exportLongTaskTitle: "正在导出数据",
          exportLongTaskDetail: "正在准备快捷方式与书签内容",
          exportReadingLocalTitle: "正在读取本地数据",
          exportReadingLocalDetail: "正在收集当前设备上的快捷方式与书签",
          exportAssemblingTitle: "正在整理导出内容",
          exportAssemblingDetail: "正在组装 LeafTab 备份文件",
          exportGeneratingTitle: "正在生成导出文件",
          exportGeneratingDetail: "马上就可以保存到本地",

          cloudBackupLongTaskTitle: "正在备份云端当前数据",
          cloudBackupLongTaskDetail: "导入前会先保存一份当前账号云端副本",
          cloudBackupReadingTitle: "正在读取云端当前数据",
          cloudBackupReadingDetail: "正在生成导入前备份，避免误覆盖",
          cloudBackupImportingTitle: "正在导入备份数据",
          cloudBackupImportingDetail: "正在把你选择的数据写入当前设备",
        },
        cloud: {
          configTitle: "云同步设置",
    ...
    weather: {
      ...
      wallpaper: {
        ...
        dynamicDesc: "动态背景占位框架，后续可继续接入真实动态壁纸资源。",
