...
export const AI_BOOKMARK_SUGGESTION_LIMIT = 12;
export const AI_BOOKMARK_SEMANTIC_RESULT_MIN_SCORE = 0.2;
export const AI_BOOKMARK_SEMANTIC_RESULT_MIN_SCORE_CJK = 0.24;
export const AI_BOOKMARK_FALLBACK_SUPPLEMENT_LIMIT = 4;
export const AI_BOOKMARK_FALLBACK_SUPPLEMENT_MIN_SCORE = 0.28;
