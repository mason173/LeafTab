...
export const AI_BOOKMARK_SANDBOX_PRELOAD_TYPE = 'leaftab-ai-bookmarks:preload';
...
export type AiBookmarkSandboxPreloadRequest = {
  modelId: AiBookmarkModelId;
};
...
export type AiBookmarkSandboxPreloadResponse =
  | {
      kind: 'result';
      ok: true;
    }
