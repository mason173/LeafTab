    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          surfaceBackdrop
            ? "[&>*:not([data-settings-surface-backdrop='true']):not([data-slot='dialog-close'])]:relative [&>*:not([data-settings-surface-backdrop='true']):not([data-slot='dialog-close'])]:z-10 [&>[data-slot='dialog-close']]:z-20"
            : "",
          className,
        )}
        {...props}
