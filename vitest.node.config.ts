  ...
  return {
    ...
    test: {
      ...
      include: [
        ...
        'src/features/shortcuts/drag/__tests__/resolveFolderDropIntent.test.ts',
        'src/features/shortcuts/drag/__tests__/resolvePragmaticFolderDropIntent.test.ts',
        'src/features/shortcuts/drag/__tests__/resolvePragmaticRootDropIntent.test.ts',
